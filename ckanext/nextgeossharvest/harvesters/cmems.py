...
class CMEMSHarvester(CMEMSBase, NextGEOSSHarvester, SpatialHarvester, SingletonPlugin):
    '''
        ...
        try:
            ...
            if 'start_date' in config_obj:
                try:
                    ...
                    raise ValueError('start_date must be in the format YYYY-MM-DD or the keyword YESTERDAY')
            else:
                raise ValueError('start_date must be in the format YYYY-MM-DD or the keyword YESTERDAY')
            if 'end_date' in config_obj:
                ...
                raise ValueError('end_date must be in the format YYYY-MM-DD or the keyword YESTERDAY')
    ...
    def gather_stage(self,harvest_job):
        ...
        ids = self._get_metadata_create_objects(start_date, end_date, start_date_to_inc, self.job, current_guids, current_guids_in_harvest)
