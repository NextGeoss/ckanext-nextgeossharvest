COLLECTION_DESCRIPTIONS = {
    "CGS S1 SLC L1":
    ("S1 datasets processed on VITO premises. Level-1 Single Look Complex "
     "(SLC) products consist of focused SAR data, geo-referenced using orbit "
     "and attitude data from the satellite, and provided in slant-range "
     "geometry. Slant range is the natural radar range observation coordinate, "
