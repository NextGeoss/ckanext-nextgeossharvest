...
from ckanext.nextgeossharvest.lib.energydata_base import EnergyDataBaseHarvester
...
class EnergyDataHarvester(EnergyDataBaseHarvester, NextGEOSSHarvester,
                        HarvesterBase):
    """A Harvester for EnergyData Data."""
    implements(IHarvester)

    def info(self):
        return {
            'name': 'EnergyData',
            'title': 'EnergyData Harvester',
            'description': 'A Harvester for EnergyData Data'
        }
    ...
    def gather_stage(self, harvest_job):
        log = logging.getLogger(__name__ + '.EnergyData.gather')
        log.debug('EnergyDataHarvester gather_stage for job: %r', harvest_job)
        ...
        base_url = 'https://energydata.info'
