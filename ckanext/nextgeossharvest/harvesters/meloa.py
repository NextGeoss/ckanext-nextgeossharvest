...
from ckanext.nextgeossharvest.lib.meloa_base import MELOAbaseHarvester
...
class MELOAHarvester(MELOAbaseHarvester, NextGEOSSHarvester,
                        HarvesterBase):
    """A Harvester for MELOA Wavy Data."""
    implements(IHarvester)

    def info(self):
        return {
            'name': 'meloa',
            'title': 'MELOA Harvester',
            'description': 'A Harvester for MELOA Wavy Data'
        }
    ...
    def gather_stage(self, harvest_job):
        log = logging.getLogger(__name__ + '.MELOA.gather')
        log.debug('MELOAHarvester gather_stage for job: %r', harvest_job)
        ...
        base_url = 'http://catalogue.ec-meloa.eu'
    ...
    def _get_entries_from_results(self, json_result):
        ...
        # All datasets in MELOA catalogue belong to a group.
        # Each group corresponds to the campaign when the Data was collected.
        # CMEMS datasets are also available for the campaigns.
