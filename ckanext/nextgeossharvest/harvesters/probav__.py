...
class PROBAVHarvester(OpenSearchHarvester, NextGEOSSHarvester):
    ...
    def _parse_content(self, content):
        content_dict = {}
        content_dict['name'] = str(uuid.uuid4())
        content_dict['title'] = 'HEY'
        content_dict['notes'] = 'notas'
        content_dict['harvest_source_id'] = self.obj.job.source.id
        content_dict['tags'] = list()
        self._set_source_config(self.obj.job.source.config)
        return content_dict
