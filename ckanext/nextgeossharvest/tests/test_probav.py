...
class TestSProbavHarvester(TestCase):
    ...
    def test_get_metalink_file_entries(self):
        ...
        self.assertEqual(metalink_entries[0]['name'],
                         "PROBAV_S1_TOA_X00Y00_20180101_100M_V101.HDF5")
        self.assertTrue(
            all(file_entry['name'].endswith('.HDF5')
...
class TestProbavHarvester(TestCase):
    ...
    def test_open_search_pages_from(self):
        ...
        self.assertEqual(
            open_search_first_page.find('totalResults').string, '158')
    ...
    def test_bbox_to_polygon(self):
        ...
        self.assertEqual(
            polygon,
            [[145.476, 65.071], [165.962992, 65.071], [165.962992, 40.341],
             [145.476, 40.341], [145.476, 65.071]])
